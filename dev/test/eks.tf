module "skyhive-eks" {
    ...
    eks-security-group              = module.skyhive-sg.this_id
...
module "eks-nodepool" {
    source = "../../mono-infra/modules/eks-nodepool/"

    eks_cluster_name                = module.skyhive-eks.cluster_name
    nodegroup-config                = var.nodegroup-config
    eks-node-subnets                = module.private-subnets.this_subnets_ids
